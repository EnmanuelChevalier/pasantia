...
if($_POST){
    ...
    $sentencia = $conexion->prepare("INSERT INTO tbl_empleados (ID, nombreempresa, queofreces	, tecnicaespecializada	, ubicacion) VALUES (NULL, :nombreempresa, :queofreces	, :tecnicaespecializada	, :ubicacion)");

...
$url_base="http://localhost/5todeinformatica/mvp/admin/index.php";
        ...
        <header>
           <nav class="navbar navbar-expand navbar-light bg-light">
            <div class="nav navbar-nav">
                ...
                <a class="nav-item nav-link" href="<?php echo $url_base;?>seccion/pasantias/">Pasantías</a>
                <a class="nav-item nav-link" href="<?php echo $url_base;?>seccion/testimonios/">Testimonios</a>
                <a class="nav-item nav-link" href="<?php echo $url_base;?>seccion/categorias/">Categorías</a>
                
                <a class="nav-item nav-link" href="<?php echo $url_base;?>seccion/usuarios/">Usuarios</a>
                <a class="nav-item nav-link" href="<?php echo $url_base;?>seccion/empresa1/">Empresa</a>
